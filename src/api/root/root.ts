...
export const getRootRootQueryOptions = <TData = Awaited<ReturnType<typeof rootRoot>>, TError = AxiosError<unknown>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof rootRoot>>, TError, TData>, axios?: AxiosRequestConfig}
) => {
...
export const useRootRoot = <TData = Awaited<ReturnType<typeof rootRoot>>, TError = AxiosError<unknown>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof rootRoot>>, TError, TData>, axios?: AxiosRequestConfig}
